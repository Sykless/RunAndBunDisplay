...
TRAINERLIST = [
    ...
    TrainerData("Cool Trainer Brooke", "Route 111", 0X0202637B, 6, [584,73,87,467,614], [523,445], "TRAINER_PIC_COOLTRAINER_F"),
    TrainerData("Pokémaniac Wyatt", "Route 113", 0X020263C8, 7, [584,73,87,467,614], [479,522,503,522], "TRAINER_PIC_COOLTRAINER_F"),
    ...
    TrainerData("Cool Trainer Gerald", "Lavaridge Gym", 0X020263C1, 0, [324,224,980,467,776], [481,340,340], "TRAINER_PIC_KINDLER"),
    ...
    TrainerData("Team Magma Grunt Magma Hideout #7 & Team Magma Grunt Magma Hideout #8 [Double]", "Magma Hideout", 0X020263CB, 2, [38,241,232,103,189,59], [340,472,576,560,481,528], "TRAINER_PIC_AQUA_GRUNT_F", "TRAINER_PIC_MAGMA_GRUNT_M"),
    ...
    TrainerData("Magma Admin Courtney", "Mossdeep Space Center", 0X020262E7, 7, [492,51,697,796,794,907], [479,497,333,312,496,340], "TRAINER_PIC_MAGMA_GRUNT_F"),
